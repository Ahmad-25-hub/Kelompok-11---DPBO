...
def draw_score_board(player1_group, current_player, potted_balls_1, potted_balls_2):
    ...
    draw_text(f"PLAYER 1 ({p1_type})", font, col_1, p1_rect.x + 15, p1_rect.y + 10)
    ...
    p2_text_surf = font.render(p2_text, True, col_2)
    ...
    center_surf = large_font.render(center_text, True, WHITE)
